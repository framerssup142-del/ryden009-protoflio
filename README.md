...
## إزاي تدخل على لوحة التحكم بعد كده؟
مفيش لينك ظاهر لحد في الموقع خالص. عشان تدخل:
- وانت في الصفحة الرئيسية (مش جوه أي حقل كتابة)، اكتب كلمة **`ryden`** من الكيبورد وهتتحول تلقائيًا لـ `admin.html`
- أو افتح `yourdomain.com/admin.html` مباشرة من شريط العنوان

تقدر تغيّر الكلمة السرية دي في `js/site.js` — دوّر على `const SECRET = "ryden"`.
